...
- Hand-written only. No generated SDK code is vendored here. The Hyperscale
...
- Every starter makes the same one call and reads the same three environment
  variables. [`CONTRIBUTING.md`](../CONTRIBUTING.md) states the four rules a new language matches.
